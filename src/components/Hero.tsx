                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-primary/10 text-brand-secondary text-sm font-semibold mb-6">
                            ...
                            <span>Your Premium Food Delivery App</span>
                        </div>
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-lg">
                            Get fresh food from local restaurants and cafeterias delivered directly to you. Fast, hot, and delicious!
                        </p>
                        <div className="flex flex-wrap gap-4">
                            <button
                                onClick={() => document.getElementById('shops')?.scrollIntoView({ behavior: 'smooth' })}
                                className="primary-gradient text-white px-8 py-4 rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-orange-500/30 hover:scale-105 transition-transform"
                            >
                            ...
                            <button
                                ...
                                className="text-slate-600 dark:text-slate-400 font-bold px-4 py-4 hover:underline"
                            >
                                View Catalog ↓
                            </button>
                        </div>
                        ...
                        <div className="flex gap-12 mt-12 pt-12 border-t border-slate-100 dark:border-slate-800">
                            <div>
                                ...
                                <div className="text-sm text-slate-500 uppercase tracking-wider font-bold">Items</div>
                            </div>
                            <div>
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="aspect-square rounded-[3rem] bg-gradient-to-br from-orange-100 to-orange-50 overflow-hidden shadow-2xl relative border-8 border-white dark:border-slate-800">
                            <div className="flex items-center justify-center h-full">
                                <div className="grid grid-cols-2 gap-4 p-8">
                                    <div className="w-full aspect-square bg-white rounded-3xl shadow-lg animate-pulse" />
                                    <div className="w-full aspect-square bg-orange-400 rounded-3xl shadow-lg mt-8" />
                                    <div className="w-full aspect-square bg-orange-600 rounded-3xl shadow-lg -mt-8" />
                            ...
                            <div className="absolute top-10 right-10 glass p-4 rounded-2xl shadow-glass animate-bounce">
                                <span className="text-xs font-bold text-orange-600 uppercase tracking-widest">Hot Deal</span>
                                <div className="text-2xl font-black">Free Delivery</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
